    ...
    public static class ShapefileSample
    {
        public static IEnumerable<ILayer> CreateLayers()
        {
            ...
            try
            {
                ...
                layers.Add(CreateCountryLayer(countrySource));
                layers.Add(CreateCityLayer(citySource));
                layers.Add(CreateCountryLabelLayer(countrySource));
                layers.Add(CreateCityLabelLayer(citySource));
            }
            catch (Exception e)
            {
        ...
        public static ILayer CreateCountryLayer(IProvider countrySource)
        {
            return new Layer
            {
                ...
                Style = LineStringSample.CreateLineStringStyle()
            };
        }
        ...
        {
            var bitmapStream = new FileStream("icon.png",FileMode.Open);
            ...
            //var bitmapStream = localAssembly.GetManifestResourceStream("icon");
